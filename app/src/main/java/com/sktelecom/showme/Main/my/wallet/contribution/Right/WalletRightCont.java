...
public class WalletRightCont extends PController {
    ...
    public WalletRightCont(Activity pAct, WalletBodyFrag motherfrag, ICallbackToAct mICallbackToAct) {
        super(pAct);
        this.pAct = pAct;
    ...
    public void asViewModelCreate() {
        vm = ViewModelProviders.of(motherfrag).get("RIGHT", WalletCommonVM.class);

...
class FollowBodyFrag : PFragment() {
    ...
    internal lateinit var vm: FollowBodyVM
    internal lateinit var binding: FollowBodyFragBinding


    fun setCallback(vm: FollowBodyVM, mICallbackEvent: ICallbackEvent) {
        this.mICallbackEvent = mICallbackEvent
        this.vm = vm;
    }

    override fun abCreateView(inflater: LayoutInflater, container: ViewGroup?): View {
        binding = DataBindingUtil.inflate(inflater, R.layout.follow_body_frag, container, false)
...
//        })
    ...
    internal inner class CommonListAdapter internal constructor() : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
            if (viewType == PBean.TYPE_CONTENTS) {
                val binding = FollowItemBinding.inflate(LayoutInflater.from(viewGroup.context), viewGroup, false)
        ...
        internal inner class ItemViewHolder internal constructor(val ibinding: FollowItemBinding) : RecyclerView.ViewHolder(ibinding.getRoot()) {
    ...
    companion object {
        ...
        fun with(vm: FollowBodyVM, mICallbackEvent: ICallbackEvent): FollowBodyFrag {
            val frag = FollowBodyFrag()

...
class ProfileActivity : PActivity() {

    internal lateinit var binding: ActivityProfileBinding
    internal lateinit var mBody: ProfileBodyVM
    ...
    override fun onAfaterCreate(savedInstanceState: Bundle?) {
        ...
        mBody = ViewModelProviders.of(this).get(ProfileBodyVM::class.java)
        mBody.asFragCreate()

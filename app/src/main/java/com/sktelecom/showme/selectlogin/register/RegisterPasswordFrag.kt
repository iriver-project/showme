...
class RegisterPasswordFrag : PFragment() {
    ...
    internal lateinit var binding: RegisterPasswordFragBinding
    ...
    override fun abCreateView(inflater: LayoutInflater, container: ViewGroup?): View {
        binding = DataBindingUtil.inflate(inflater, R.layout.register_password_frag, container, false)
    ...
    companion object {
        fun with(vm: RegisterVM, mICallbackEvent: ICallbackEvent): RegisterPasswordFrag {
            val frag = RegisterPasswordFrag()

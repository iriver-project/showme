...
class LoginFirstFrag : PFragment() {
    ...
    internal lateinit var binding: LoginFirstFragBinding
    ...
    override fun abCreateView(inflater: LayoutInflater, container: ViewGroup?): View {
        binding = DataBindingUtil.inflate(inflater, R.layout.login_first_frag, container, false)
    ...
    companion object {
        fun with(vm: LoginVM, mICallbackEvent: ICallbackEvent): LoginFirstFrag {
            val frag = LoginFirstFrag()
